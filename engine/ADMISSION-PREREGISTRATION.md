...
| G-A2 pre-check, real-app run | green | report `frontends/shell/e2e/out/source-changed-1789739677575.json`, 2026-09-18 |
| G-A2 post-check, real-app run | green | report `frontends/shell/e2e/out/source-changed-1789739850935.json`, 2026-09-18; isolated run, no prior route in the same app session |
| G-A2 post-check, recorded mutation | run, observed failure | `frontends/shell/src/residency/candidateArmSession.ts:1076`'s `canvas?.clearAllTiles();` removed from `endCandidateSession`; report `frontends/shell/e2e/out/source-changed-1789739920074.json`, 2026-09-18; step `S5b-residency-cleared` failed, `S5a`/`S5c`/`S5d` still green |
| G-A2 post-check, reverted run | green | report `frontends/shell/e2e/out/source-changed-1789739975354.json`, 2026-09-18; `git diff --stat` on `candidateArmSession.ts` empty before this row was written |
