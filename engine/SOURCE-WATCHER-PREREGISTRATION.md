...
### Amendment 6 — 2026-09-26, written after gate 2's results were seen (architect and reviewer FAIL at `68f5c56`, record only): the closing record

References and hashes only (`state/directives/2026-09-18-record-cap.md`). The rows are the architect's gate-2 report, §6, which supersedes the fix ruling's §5; each names its template class. Gate 1's reports are `state/consults/2026-09-26-source-watcher-gate1-reviewer.md` (R) and `state/consults/2026-09-26-source-watcher-gate1-architect.md` (A), at `04b3680`; gate 2's are `state/consults/2026-09-26-source-watcher-gate2-reviewer.md` (G2R) and `state/consults/2026-09-26-source-watcher-gate2-architect.md` (G2A), at `3dfc622`. Each hash is `git show <rev>:<path> | sed -n '<a>,<b>p' | sha256sum` over LF bytes. The fix round is `2daf371..f280f76`; gate 2's record fixes are `b178ee5`; main was merged at `722a551`.

1. **Class 1, the observation of record for every mutation:** R's mutations, `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:81-116 @ 04b3680 sha256:2442590134d160c531e4fc3fb68fff46e4868ed8754a0174e65406bb34cf3b13`; G2R's mutation table (K15's two mutations, E7's registered mutation, the two pins, SH7, SH8, SH11), `state/consults/2026-09-26-source-watcher-gate2-reviewer.md:82-95 @ 3dfc622 sha256:248a3217e7e93b717f3004b9ce9a8e6941a0c5b211e914bedc36e5d7742b05b4`, and its E10 line, `state/consults/2026-09-26-source-watcher-gate2-reviewer.md:72 @ 3dfc622 sha256:304b7c44f34b8b2d2ff75725b5f3d4844df9f51829647e43b7d1f389f0d225d7`; the gate-log entries for `engine-source-change-watcher`: attempt 1 (dfdc8fb), attempt 2 (3dfc622) and attempt 3.
2. **Class 3, Amendment 3 item 5's last sentence.** It names the gate's `verify-mutation` run as the observation of record, but `verify-mutation` @ `7d24ed1` checks that a mutation is recorded and runs none. The corrected reference is row 1; the proof is `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:60 @ 04b3680 sha256:c6e005ffeeda4417422e134a86ad03d2fe6427c356ffa8dad58fd0e13bb27458`.
3. **Class 1, H1, H2, H3 and H5:** `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:75-78 @ 04b3680 sha256:84719194d8e7bf307e0677e86c4245dbdfda8079f1ba88618fa5aa36b6ef3902`. H4 is not restated.
4. **Class 1, the E2E:** `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:62-69 @ 04b3680 sha256:00648cd2aa35c6a92acc3bdccb76a50e4788a1a84b1b1ccca1a0b0be8391ed88`; the W4 miss, `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:71 @ 04b3680 sha256:292fb14e0414b2df3f5d9b8273707cbb86a65b40fe0af8a574643ee8205c2e31`; gate 2's rerun, `state/consults/2026-09-26-source-watcher-gate2-reviewer.md:112-122 @ 3dfc622 sha256:3fc4771c146d02251fcb23ba9874bf69df39c4916bb4bc7bb52ee90fd22f7bcb`, its report file's sha256 5d7882c069880b8ec8bd9575d0c5eec7f19bf2793cbc9911bdba5dc1a4008262.
5. **Class 1, the budget:** G2R's per-module figures, total and file count under §21c, `state/consults/2026-09-26-source-watcher-gate2-reviewer.md:124-135 @ 3dfc622 sha256:7a6435a535127595639f17f7c4cc658dac47f750b6a6e55785401d2b3c5505ad`, recounted unchanged at `722a551`. The fold-in commits are d90837d (mixed) and e372848. Gate 1's figures: `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:120-133 @ 04b3680 sha256:fb789316ded1d6147813652dcc7e888a1c11cea93612187ae712d71d8f3ce4b0`.
6. **Class 2, SH5's equivalent mutant:** `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:102-104 @ 04b3680 sha256:0de8a535c17b9159d25067288d14a321652959d64676c512288342831be6b676`.
7. **Class 2, E7's registered mutation:** observed at `state/consults/2026-09-26-source-watcher-gate1-reviewer.md:84 @ 04b3680 sha256:4f6f85e8e68c344eb85420be6b2eaab7e833fdabff342b172626128548420bf0`, and in G2R, `state/consults/2026-09-26-source-watcher-gate2-reviewer.md:87 @ 3dfc622 sha256:c0d50fa38988e4b338e1bf7139db2ec263c3c27390fd6bee4a67c0f52eadfd2c`.
8. **Class 1, SH12's prediction miss:** `state/consults/2026-09-26-source-watcher-gate1-architect.md:94-96 @ 04b3680 sha256:c2b2989f9f389fdccd54348e1e2d95a9ee1a9e727d730c34712f6acc88add4f1`.
9. **Class 1, advisory 6:** `state/consults/2026-09-26-source-watcher-gate1-architect.md:58 @ 04b3680 sha256:cc43abd4e5d313b930ad1217f7b14092256d26ae230a9ddb6f8e6e4fdcca3b18`.
10. **Class 1, K15's second mutation:** it fails on the shipped `unreachable!` at the refusal path's re-lock, not on the mark. The mark clause is proven by assertion only, in `ticket_drop_under_lock_regression::a_coverage_loss_racing_admission_refuses_with_its_own_code_and_leaves_no_mark`; `state/consults/2026-09-26-source-watcher-gate2-reviewer.md:84-86 @ 3dfc622 sha256:6ae7828a2cc063712f9037f20b495bb4895791eb8df96fe6e3845468cc4c49e9`.
11. **Class 5, the discharge of Amendment 5 item 4:** B1, B2 and the use-after-free, proved by reading, `state/consults/2026-09-26-source-watcher-gate2-architect.md:46-50 @ 3dfc622 sha256:1f825656fb040ef553b78b7828df414a8d619534b89060aac411a147938ca2b4`.
12. **Class 2, R-b's secondary shell check:** §4's `the listener logs no session reference` was deleted under the fix ruling's item 10. Its property is carried by `drops an event whose session does not match, and logs a line naming the reason only (SH9, SH11)` in `frontends/shell/src/App.test.ts`.
