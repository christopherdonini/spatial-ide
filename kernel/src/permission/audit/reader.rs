...
mod tests {
    ...
    fn fixture() -> String {
        [
            ...
            r#"{"schema":"spatial-audit/1","attempt":"aaa1","phase":"intent","at":"2026-08-17T08:44:08Z","operation":"publish-static-bundle","class":3,"reversibility":"irreversible","principal_kind":"os-user","principal_name":"someone","source_name":"parcels","source_content_hash":"sha256:aa","destination":"C:/dev/out/parcels","style_hash":"sha256:bb","residual_classes":["local-filesystem-path"]}"#,
            r#"{"schema":"spatial-audit/1","attempt":"aaa1","phase":"outcome","at":"2026-08-17T08:44:09Z","outcome":"success","error_kind":null,"grantor_kind":"os-user","grantor_name":"someone","grant_lifetime_s":120,"grant_remaining_s":99,"approval_route":"shell-dialog","operation_digest":"sha256:cc","manifest_hash":"sha256:dd","rows":2000,"partitions":1,"residual_classes":[]}"#,
            // Attempt B: intent + a refused outcome.
            r#"{"schema":"spatial-audit/1","attempt":"bbb2","phase":"intent","at":"2026-08-17T09:00:00Z","operation":"publish-static-bundle","class":3,"reversibility":"irreversible","principal_kind":"os-user","principal_name":"someone","source_name":"parcels","source_content_hash":"sha256:aa","destination":"C:/dev/out/refused-one","style_hash":"sha256:bb","residual_classes":["local-filesystem-path"]}"#,
            r#"{"schema":"spatial-audit/1","attempt":"bbb2","phase":"outcome","at":"2026-08-17T09:00:00Z","outcome":"refused","error_kind":"ApprovalRefused","grantor_kind":"os-user","grantor_name":"someone","grant_lifetime_s":120,"grant_remaining_s":118,"approval_route":"shell-dialog","operation_digest":null,"manifest_hash":null,"rows":null,"partitions":null,"residual_classes":[]}"#,
