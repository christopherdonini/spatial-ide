...
**Claude Code facts used here are verified against the installed version's documentation (Claude Code 2.1.270; `https://code.claude.com/docs/en/hooks`, `.../hooks-guide`, `.../model-config`, fetched 2026-09-13) — nothing is built from memory.** The verbatim quotes are in Appendix B; every hook field named in §3 and §7 appears there.
