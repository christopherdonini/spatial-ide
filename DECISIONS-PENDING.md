...
119. **[RULED 2026-09-23 (late) — see the RULED block at the top; recorded as filed:]** **[FOR YOUR WORD — the five ADR acceptances, presented together at P6 after your N8 retest; two of the proposed texts are not yet true of the build.]** Context: Part N run 1 (N1–N7 PASS, N9 as given) and your N8 retest of 2026-09-23 are recorded in `frontends/shell/MANUAL-WALKTHROUGH.md`'s Part N run section. The retest passed as reported, on 7301dc6, which has PR #100 and not PR #101. Each proposed text is on main; it is appended to its ADR only on your word, with its PROPOSED file deleted in the same commit, as one PR for your click. Checked against the build, two proposed texts claim what the build does not do. ADR-013 Amendment 1 item 5 (`docs/adr/PROPOSED-amendment-to-ADR-013-geographic-degrees-instance.md:44`) requires the shell's status at open to carry the equirectangular statement, but no component renders it. The statement exists only on describe's wire (`engine/src/crs.rs:54`, `kernel/src/skp.rs:1058`, `frontends/shell/src/skp/types.ts:100`); entry 113 (3) raised this and it was never put to you. ADR-016 Amendment 1 item 2 (`docs/adr/PROPOSED-amendment-to-ADR-016-identity-tier-model.md:49`) says the descriptor's degradation is shown, but nothing shows it (`engine/ADMISSION-PREREGISTRATION.md` Amendment 4 (ii)); no corpus file reaches a degradation. **The five:**
