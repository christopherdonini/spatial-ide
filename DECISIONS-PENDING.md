...
128. **[FOR YOUR WORD, the morning round — `crs-unit-fact-and-bounds` (PR #112) STOPPED under Rule 7: full-gate attempt 2 failed in both gates on one semantic item; the code, wire and scope pass.]**
