...
[[KL-N]]. **A bundle carries its author's viewer code: opening a bundle means running that author's
    ...
    up a later viewer fix. Fixed for every bundle published by a build that includes PR #128 or later:
