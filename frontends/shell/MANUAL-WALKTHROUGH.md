...
This Part discharges two preregistrations: `engine/ADMISSION-PREREGISTRATION.md` §12b, gate **G-A7
"Part N operator-verified"**; and P3b's own record of what it owes this file,
...
a claim origin/main reads this way now: it has since moved to `5632f94`, which touches only a stray
spike `Cargo.toml`, and the two commits between `004820b` (this branch's original base) and `158d450`
