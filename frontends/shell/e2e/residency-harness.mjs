 ...
 *     `isInstrumentedBuild()` is true (`WorkingCanvas.tsx:1534`'s own `if (isInstrumentedBuild())`
...
async function assertNoInViewportTileEvicted(page, tileIngestListener, { instrumentEnabled, sinceSeq, postViewState }) {
  if (!instrumentEnabled) {
    return { corroborated: false, reason: "not instrumented -- [render-trace] tile-ingest is instrument-gated (WorkingCanvas.tsx:1534)" };
  }
