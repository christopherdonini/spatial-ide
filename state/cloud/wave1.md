...
|---|---|---|---|---|---|---|---|---|---|
| A3 (calibration, alone) | session_01STxb5ot2J5RaYpnzffmSq6 (prompt: `state/cloud/wave1/A3-prompt.md`) | Opus 5.5, Medium (as launched) | 2026-09-25T06:41:30Z | pending | $250 of $250 left (Cloud session credits, claude.ai Settings → Usage, read 2026-09-25 about 06:40Z) | pending | pending | pending | pending |
