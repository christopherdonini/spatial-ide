# Wave 1, A1 (batch 1, pair 1, with A2): the launched prompt

- **Session ID:** session_01Dvwb34AguXpmzqPFN5SLGQ (https://claude.ai/code/session_01Dvwb34AguXpmzqPFN5SLGQ)
- **Launched:** 2026-09-25T22:24:22Z, from claude.ai/code. The environment was Default and the repository christopherdonini/spatial-ide, on branch main at a43fb28. The model was Opus 5.5 at Medium effort, as the composer showed at launch.
- **Assembly:** built by script per `state/cloud/wave1-prompts.md` §7, as amended by its deviation 1, read from main at a43fb28. It is A1 in full, with the branch name and the TASK block for A1, and §3's worker fields pasted. For A1 itself, the TASK block is A1's own. The same script reproduces A3's recorded prompt, sha256 a408c1d8, byte for byte.
- **Exactness:** 66 lines, sha256 674ffb07da68a31902ba72100ddcf3c6f10ba076d23bee69c3e7562f98e3ddce. The same hash was computed from the clipboard (LF-normalised) and from the composer's paragraphs joined by newlines, just before sending.
