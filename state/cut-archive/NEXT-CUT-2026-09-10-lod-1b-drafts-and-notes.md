...
All under `RELEASE-DRAFTS-0.1.0/post-tag/` (untracked, repository root), each headed with its provenance (which agent, read-only, the recommendation lines labelled as the drafter's):
