...
function rustCrateSectionLines(heading, underline, crates, canonicalTexts, targetTriple = null) {
  ...
  if (canonicalTexts.size > 0) {
    out.push(
      ...
      'records for each one the URL it was fetched from, the date, and its sha256.',
      '',
      ...
      '(for example "Copyright (c) <year> <owner>"): no crate below ships a copyright notice of its',
      'own in its registry source, and none is invented here. Some licences (MPL-2.0) have no such',
      'line at all, and are reproduced as they stand.',
      '',
